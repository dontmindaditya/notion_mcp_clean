 ...
 *
 * With Next.js Proxy Architecture:
 *   - Requests proxied through Next.js rewrites appear to come from the frontend origin
 *   - The Origin header will be the browser's origin (APP_URL)
 *   - This is the expected behavior and should be allowed
 *
 * Strategy:
