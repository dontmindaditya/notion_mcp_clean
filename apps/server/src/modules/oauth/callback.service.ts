 ...
 * 
 * Notion requires HTTP Basic Authentication for the token endpoint:
 *   Authorization: Basic base64(client_id:client_secret)
 * 
 * The client credentials should NOT be in the request body.
 */
export async function exchangeCodeForTokens(
  ...
  // Build the request body - NOT including client credentials
  ...
  // ── Diagnostic: Log token response structure ───
  logger.info("Token exchange successful", {
    ...
    // Log all keys received to debug structure
